...
They remain unit-test modules in the binary's test harness. Hybrid authentication
tests live in `dhan_api/dhan_auth.rs`; token endpoint tests live in `access_token/get_token.rs`. The mocked end-to-end consent flow lives in
